...
void MyMessage_Base::copy(const MyMessage_Base& other)
{
    ...
    this->destination_node = other.destination_node;
    this->source_node = other.source_node;
...
void MyMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->destination_node);
    doParsimPacking(b,this->source_node);
...
void MyMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->destination_node);
    doParsimUnpacking(b,this->source_node);
    doParsimUnpacking(b,this->sequence);
    doParsimUnpacking(b,this->ack);
    doParsimUnpacking(b,this->M_Payload);
}

frame_type& MyMessage_Base::getType()
{
    return this->type;
}

void MyMessage_Base::setType(const frame_type& type)
{
    this->type = type;
}

unsigned int MyMessage_Base::getDestination_node() const
{
    return this->destination_node;
}

void MyMessage_Base::setDestination_node(unsigned int destination_node)
{
    this->destination_node = destination_node;
}

unsigned int MyMessage_Base::getSource_node() const
{
    return this->source_node;
}

void MyMessage_Base::setSource_node(unsigned int source_node)
{
    this->source_node = source_node;
}

sequence_number& MyMessage_Base::getSequence()
{
    return this->sequence;
}

void MyMessage_Base::setSequence(const sequence_number& sequence)
{
    this->sequence = sequence;
}

sequence_number& MyMessage_Base::getAck()
{
    return this->ack;
}

void MyMessage_Base::setAck(const sequence_number& ack)
{
    this->ack = ack;
}
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "destination_node")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "source_node")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "sequence")==0) return base+3;
    if (fieldName[0]=='a' && strcmp(fieldName, "ack")==0) return base+4;
    if (fieldName[0]=='M' && strcmp(fieldName, "M_Payload")==0) return base+5;
...
std::string MyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return ulong2string(pp->getDestination_node());
        case 2: return ulong2string(pp->getSource_node());
        case 3: {std::stringstream out; out << pp->getSequence(); return out.str();}
        case 4: {std::stringstream out; out << pp->getAck(); return out.str();}
        case 5: return oppstring2string(pp->getM_Payload());
        default: return "";
    }
}
...
bool MyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    MyMessage_Base *pp = (MyMessage_Base *)object; (void)pp;
    switch (field) {
        case 1: pp->setDestination_node(string2ulong(value)); return true;
        case 2: pp->setSource_node(string2ulong(value)); return true;
        case 5: pp->setM_Payload((value)); return true;
...
const char *MyMessageDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(frame_type));
        case 3: return omnetpp::opp_typename(typeid(sequence_number));
        case 4: return omnetpp::opp_typename(typeid(sequence_number));
        default: return nullptr;
    };
}
...
void *MyMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)(&pp->getSequence()); break;
        case 4: return (void *)(&pp->getAck()); break;
        default: return nullptr;
    }
}
